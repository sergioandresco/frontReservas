...
function FormCreateEvent() {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            alert('¡Ha ocurrido un problema, sigue intentando!');
        }
    }
    ...
    return (
        ...
        <div id="Container">
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div id="login-lable">Crea un evento</div>

                <input className="form-content" type="text" id="eventName" name="name" value={name} onChange={e => setName(e.target.value)} placeholder="Nombre del evento" />

                <input className="form-content" type="text" id="description" name="description" value={description} onChange={e => setDescription(e.target.value)} placeholder="Descripción del evento" />

                <input className="form-content" type="date" id="dateEvent" name="date_event" value={dateEvent} onChange={e => setDateEvent(e.target.value)} />

                <input className="form-content" type="number" id="numSeats" name="number_of_places" min="1" value={numberOfPlaces} onChange={e => setNumberOfPlaces(e.target.value)} placeholder="Número total de asientos" />
