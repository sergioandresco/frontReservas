    ...
    return(
        ...
        <div id="Container">
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div id="login-lable">¡Reserva tu lugar!</div>
                <div id="login-lable-2">Asientos disponibles: {selectedEventPlaces}</div>

                <input className="form-content" type="number" id="eventName" name="name" value={quantity} onChange={(e) => setQuantity(Number(e.target.value))} placeholder="Cantidad de lugares a reservar:" />
